...
const drawTutorialHUD = (): void => {
  ...
  drawText(`${ludwigTheming ? "Coots" : "Kitty"} wants food! Guide her to cause a ruckus and get ${ludwigTheming ? "Ludwig" : "owner"}'s attention!`, "#ffffff", x, 6, 1, width - 4, 10, "left", "top");
